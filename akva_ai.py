...
async def lop(message):
    ...
    if message.chat.type == 'private':
        ...
        if message.text == 'Помолица🙏':
            ...
            # вторая икона для молитвы
            await bot.send_photo(message.chat.id, cop_2)
            # третя икона для молитвы
            await bot.send_photo(message.chat.id, cop_3)
        ...
        # ""_____Пожертвовать 💳_____""
            ...
            itm2 = types.InlineKeyboardButton(
                "Пожертвовать 💌", url="https://prt.mn/balgWGXPiv")
